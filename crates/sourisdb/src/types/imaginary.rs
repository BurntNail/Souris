...
pub enum Imaginary {
    IntegerCoefficients { real: Integer, imaginary: Integer },
    PolarForm { modulus: f64, argument: f64 },
}
...
impl Imaginary {
    ...
    #[must_use]
    pub fn to_integer_coefficients(self) -> Result<Self, (Self, FloatToIntegerConversionError)> {
        match self {
    ...
    #[must_use]
    pub fn polar_from_real_and_imaginary(real: f64, imaginary: f64) -> Self {
